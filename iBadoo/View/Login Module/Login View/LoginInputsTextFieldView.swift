...
class LoginView: BaseUIView, UITextFieldDelegate {
    ...
    private func setupLayouts() {
        ...
        textFieldStack.anchor(top: backButton.bottomAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 25, left: 0, bottom: 0, right: 0), size: .init(width: 0, height: 200))
...
//        textFieldStack.anchor(top: topAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: .init(top: 0, left: 35, bottom: 0, right: 35), size: .zero)
        ...
        [backButton, xCloseButton, bottomStack , loginButton].forEach { addSubview($0) }
...
//        loginInputsTextFieldView.anchor(top: backButton.bottomAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 25, left: 0, bottom: 0, right: 0), size: .init(width: 0, height: 0))
